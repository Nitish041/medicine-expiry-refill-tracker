...
router.post("/", async (req, res) => {
  ...
  if (!name || !batch_no || !manufacturer || !purchase_date || !expiry_date || !price || !quantity || !supplier_id) {
  ...
  try {
    const [result] = await pool.query(
      ...
      (name, batch_no, manufacturer, barcode, supplier_id, purchase_date, expiry_date, price, quantity, reorder_level) 
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        name,
        batch_no,
